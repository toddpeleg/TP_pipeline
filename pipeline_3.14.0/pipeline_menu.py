...
def build_menu():
    ...
    # 3.13.0 — File Xfer Assist: collect actual scene files (latest work,
    # optional publishes/dependencies) into io/file_xfer_assist/<date>/ to
    # carry to another machine, and import them back there. See the
    # "File Xfer Assist" module comment.
    cmds.menuItem(label="File Xfer Assist", command=lambda *a: show_file_xfer_assist_panel(), parent=menu)
...
def _file_xfer_stylesheet():
    t = AM_TOKENS
    p = FILE_XFER_PANEL_OBJECT_NAME
