...
def show_asset_manager_panel():
    ...
    panel.show(dockable=True, floating=True, width=ASSET_MANAGER_PANEL_WIDTH, height=300)
    return panel
...
OPEN_SCENE_WINDOW_SIZE = (980, 600)  # 3.8.0: +40 height for the new header bar, matching Asset Manager's 3.7.0 bump
...
def _open_scene_stylesheet():
    ...
    t = OPEN_SCENE_TOKENS
    return f"""
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} {{
            background: {t['bg_panel']};
            color: {t['text_primary']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTreeWidget,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QListWidget,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTableWidget {{
            background: {t['bg_content']};
            alternate-background-color: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTreeWidget::item,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QListWidget::item {{
            background: transparent;
            color: {t['text_primary']};
            padding: 3px 4px;
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTreeWidget::item:hover,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QListWidget::item:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTreeWidget::item:selected,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QListWidget::item:selected,
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTableWidget::item:selected {{
            background: {t['selection_bg']};
            color: {t['selection_text']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QHeaderView::section {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: none;
        ...
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QPushButton {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            border-radius: 2px;
        ...
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QPushButton:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QPushButton:disabled {{
            color: {t['border']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QTreeWidget::branch {{
            image: none;
            border: none;
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} #openSceneHeader {{
            background: {t['bg_header']};
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QLabel#openSceneHeaderTitle {{
            color: {t['text_white']};
            font-weight: bold;
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QLabel#openSceneToggleLabel {{
            color: {t['text_muted_alt']};
            font-size: 12px;
        }}
        QWidget#{OPEN_SCENE_PANEL_OBJECT_NAME} QLabel#openSceneToggleLabelActive {{
            color: {t['text_white']};
            font-size: 12px;
            font-weight: 600;
        }}
...
class OpenScenePanel(MayaQWidgetDockableMixin, QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.file_table.setHorizontalHeaderLabels(["Version", "Date", "User", "Comment"])
    ...
    def _populate_file_table(self, pairs):
        ...
        for row_index, row in enumerate(rows):
            ...
            self.file_table.setItem(row_index, 3, QtWidgets.QTableWidgetItem(row["comment"]))
        self.open_btn.setEnabled(False)
...
SAVE_AS_WINDOW_SIZE = (980, 660)  # 3.2.0 — same width as Open Scene, taller for the bottom save panel; 3.8.0: +40 for the new header bar
...
def _save_as_stylesheet():
    ...
    t = OPEN_SCENE_TOKENS
    return f"""
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} {{
            background: {t['bg_panel']};
            color: {t['text_primary']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTreeWidget,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QListWidget,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTableWidget {{
            background: {t['bg_content']};
            alternate-background-color: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTreeWidget::item,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QListWidget::item {{
            background: transparent;
            color: {t['text_primary']};
            padding: 3px 4px;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTreeWidget::item:hover,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QListWidget::item:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTreeWidget::item:selected,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QListWidget::item:selected,
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTableWidget::item:selected {{
            background: {t['selection_bg']};
            color: {t['selection_text']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QHeaderView::section {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: none;
            border-right: 1px solid {t['border']};
        ...
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QPushButton {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            border-radius: 2px;
        ...
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QPushButton:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QPushButton:disabled {{
            color: {t['border']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QTreeWidget::branch {{
            image: none;
            border: none;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QPlainTextEdit {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QLabel#saveAsPreviewLabel {{
            color: {t['text_primary']};
            padding: 2px 0px;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QLabel#saveAsSectionLabel {{
            color: {t['text_primary']};
            font-weight: bold;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} #saveAsHeader {{
            background: {t['bg_header']};
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QLabel#saveAsHeaderTitle {{
            color: {t['text_white']};
            font-weight: bold;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QLabel#saveAsToggleLabel {{
            color: {t['text_muted_alt']};
            font-size: 12px;
        }}
        QWidget#{SAVE_AS_PANEL_OBJECT_NAME} QLabel#saveAsToggleLabelActive {{
            color: {t['text_white']};
            font-size: 12px;
            font-weight: 600;
        }}
...
class SaveAsPanel(MayaQWidgetDockableMixin, QtWidgets.QWidget):
    ...
    def _build_ui(self):
        ...
        self.version_table = QtWidgets.QTableWidget(0, 4)
        self.version_table.setHorizontalHeaderLabels(["Version", "Date", "User", "Comment"])
    ...
    def _populate_versions_table(self, pairs):
        ...
        for row_index, row in enumerate(rows):
            ...
            self.version_table.setItem(row_index, 3, QtWidgets.QTableWidgetItem(row["comment"]))
        self.overwrite_btn.setEnabled(False)
    ...
    def _on_save_new_version(self):
        ...
        _apply_scene_comment_fileinfo(comment_text)
        _save_scene_as(dest_dir, stub)  # prints + confirms, same as every other Save As path
...
def _create_shot_folders_panel_stylesheet():
    ...
    t = OPEN_SCENE_TOKENS
    return f"""
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} {{
            background: {t['bg_panel']};
            color: {t['text_primary']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::item {{
            background: transparent;
            color: {t['text_primary']};
            padding: 3px 4px;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::item:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::item:selected {{
            background: {t['selection_bg']};
            color: {t['selection_text']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::branch {{
            image: none;
            border: none;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QPushButton {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            border-radius: 2px;
        ...
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QPushButton:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QPushButton:checked {{
            background: {t['selection_bg']};
            color: {t['selection_text']};
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QLineEdit {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px 6px;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QLabel#createShotFoldersHeaderTitle {{
            color: #ffffff;
            font-weight: bold;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QLabel#createShotFoldersFormTitle {{
            color: #ffffff;
            font-weight: bold;
            font-size: 13pt;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} QLabel#createShotFoldersPreview {{
            color: #8fc87a;
        }}
        QWidget#{CREATE_SHOT_FOLDERS_PANEL_OBJECT_NAME} #createShotFoldersHeader {{
            background: {t['bg_header']};
        }}
    """
...
class CreateShotFoldersPanel(MayaQWidgetDockableMixin, QtWidgets.QWidget):
    ...
    def _prefill_flat_fields(self):
        ...
        self.flat_step_field.setText(str(step))
...
def _create_asset_folders_panel_stylesheet():
    ...
    t = OPEN_SCENE_TOKENS
    return f"""
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} {{
            background: {t['bg_panel']};
            color: {t['text_primary']};
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::item {{
            background: transparent;
            color: {t['text_primary']};
            padding: 3px 4px;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QTreeWidget::branch {{
            image: none;
            border: none;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QPushButton {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            border-radius: 2px;
        ...
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QPushButton:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLineEdit {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px 6px;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLineEdit:disabled {{
            background: #333333;
            color: #7a7a7a;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QComboBox {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px 6px;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QComboBox:hover {{
            border: 1px solid {t['selection_bg']};
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QComboBox QAbstractItemView {{
            background: {t['bg_content']};
            color: {t['text_primary']};
        ...
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLabel#createAssetFoldersHeaderTitle {{
            color: #ffffff;
            font-weight: bold;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLabel#createAssetFoldersFormTitle {{
            color: #ffffff;
            font-weight: bold;
            font-size: 13pt;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLabel#createAssetFoldersPreview {{
            color: #8fc87a;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} QLabel#createAssetFoldersSidebarTitle {{
            color: #ffffff;
            font-weight: bold;
        }}
        QWidget#{CREATE_ASSET_FOLDERS_PANEL_OBJECT_NAME} #createAssetFoldersHeader {{
            background: {t['bg_header']};
        }}
    """
        ...
        if self.project_path:
            for type_name in list_asset_category_types(self.project_path):
                ...
                for asset_name, _asset_dir in list_all_assets(self.project_path, type_name=type_name):
                    type_item.addChild(QtWidgets.QTreeWidgetItem([asset_name]))
...
def _create_custom_folder_panel_stylesheet():
    ...
    t = OPEN_SCENE_TOKENS
    return f"""
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} {{
            background: {t['bg_panel']};
            color: {t['text_primary']};
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QTreeWidget {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QTreeWidget::item {{
            background: transparent;
            color: {t['text_primary']};
            padding: 3px 4px;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QTreeWidget::branch {{
            image: none;
            border: none;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QPushButton {{
            background: {t['bg_header']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            border-radius: 2px;
        ...
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QPushButton:hover {{
            background: {t['hover_bg']};
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QLineEdit {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px 6px;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QComboBox {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            border: 1px solid {t['border']};
            padding: 4px 6px;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QComboBox:hover {{
            border: 1px solid {t['selection_bg']};
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QComboBox:disabled {{
            background: #333333;
            color: #7a7a7a;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QComboBox QAbstractItemView {{
            background: {t['bg_content']};
            color: {t['text_primary']};
            selection-background-color: {t['selection_bg']};
            selection-color: {t['selection_text']};
        ...
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QLabel#createCustomFolderHeaderTitle {{
            color: #ffffff;
            font-weight: bold;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QLabel#createCustomFolderFormTitle {{
            color: #ffffff;
            font-weight: bold;
            font-size: 13pt;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QLabel#createCustomFolderPreview {{
            color: #8fc87a;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} QLabel#createCustomFolderSidebarTitle {{
            color: #ffffff;
            font-weight: bold;
        }}
        QWidget#{CREATE_CUSTOM_FOLDER_PANEL_OBJECT_NAME} #createCustomFolderHeader {{
            background: {t['bg_header']};
        }}
    """
